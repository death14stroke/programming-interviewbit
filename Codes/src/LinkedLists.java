class LinkedLists {
    ...
    static ListNode partition(ListNode head, int B) {
        ...
        ListNode smaller = smallerDummy, greater = greaterDummy, curr = head;

        while (curr != null) {
            // append at the end of < B list
            if (curr.val < B) {
                smaller.next = curr;
    ...
    static ListNode mergeSortedLinkedLists(ListNode head1, ListNode head2) {
        ...
        // if first list has not reached end
        if (head1 != null)
            curr.next = head1;
            // if second list has not reached end
        else
            curr.next = head2;
    ...
    static ListNode swapPairs(ListNode head) {
        ...
        ListNode node1 = head, prev = dummy;
    ...
    static ListNode reorderList(ListNode head) {
        // another approach is like the even-reverse question
        ...
        // alternate merge of two sublist. Already added from list 1 so start adding from list 2
